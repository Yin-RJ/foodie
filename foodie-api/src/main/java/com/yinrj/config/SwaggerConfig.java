...
import com.yinrj.contanst.ProjectDetail;
...
public class SwaggerConfig {
    ...
    public Docket createDocket() {
        ...
        // 不显示默认的error controller
        selectorBuilder.paths(Predicates.not(PathSelectors.regex("/error.*")));
        // 对根下所有路径监控
//        selectorBuilder.paths(PathSelectors.regex("/.*"));
    ...
    private ApiInfo apiInfo() {
        ...
        builder.title(projectDetail.getProjectName());
        builder.version(projectDetail.getVersion());
        Contact contact = new Contact(projectDetail.getUserName(), "", projectDetail.getEmail());
